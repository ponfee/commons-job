...
package code.ponfee.job.quartz.example13;
...
public class SimpleRecoveryJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (context.isRecovering()) {
            _log.warn("SimpleRecoveryJob: " + jobKey + " RECOVERING at " + Dates.format(context.getScheduledFireTime()));
        } else {
            _log.warn("SimpleRecoveryJob: " + jobKey + " starting at " + Dates.format(context.getScheduledFireTime()));
        }
